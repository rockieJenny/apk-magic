...
public class ResStringPool_header {
    ...
    // 绛変簬0銆丼ORTED_FLAG銆乁TF8_FLAG鎴栬�呭畠浠殑缁勫悎鍊硷紝鐢ㄦ潵鎻忚堪瀛楃涓茶祫婧愪覆鐨勫睘鎬�
    // 渚嬪锛孲ORTED_FLAG浣嶇瓑浜�1琛ㄧず瀛楃涓叉槸缁忚繃鎺掑簭鐨勶紝鑰孶TF8_FLAG浣嶇瓑浜�1琛ㄧず瀛楃涓叉槸浣跨敤UTF8缂栫爜鐨勶紝鍚﹀垯灏辨槸UTF16缂栫爜鐨勩��
    private int flags;
